...
const Login = () => {
  ...
  return (
    ...
    >
    <Form>
      <label htmlFor="email">Email : <Field type="text" name="email" id='email'/></label>
      <ErrorMessage component="small" name='email'/>
      <label htmlFor="password">Password : <Field type="password" name="password" id='password'/></label>
